export const aboutTabs = [
  ...
  },
  {
    ...
    points: [
      "Leak detection and long-term repair solutions.",
      "Drain cleaning and blockage removal.",
      "Fixture installation with clean finishing.",
      "Emergency support when timing matters most.",
    ],
  },
  {
    id: "values",
    ...
    points: [
      ...
      "Workmanship backed by accountability.",
      "Customer-first service with lasting care.",
    ],
  },
];
...
export const aboutStats = [
  ...
  { value: 98, suffix: "%", label: "Customer Satisfaction Guarantee" },
